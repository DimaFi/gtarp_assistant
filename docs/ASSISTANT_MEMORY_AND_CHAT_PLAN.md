...
Статус: **M1 и основной срез M2 завершены и прошли release gate**. Следующий этап — M3, Push-to-Talk UX.
...
- hold и toggle modes;
- preview recognized text или auto-send;
- max duration, sensitivity и explicit error states;
- тест микрофона и level meter;
