...
7. Стиль ассистента настраивается ползунками подробности, юмора, инициативности и тона на странице **Память**. Основной экран называется **Чат**: новые диалоги получают короткое название по смыслу первого вопроса, после чего название можно изменить вручную.
